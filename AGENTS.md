...
<!-- BEGIN kit-managed: agents-core (v0.11.0) -->
...
- **Slice 6 (delivered):** `standards adopt` — non-destructive adoption onto existing non-blank repos (RFC-0002 concluded, ADR-0013).
