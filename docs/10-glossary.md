...
| **Discovery note** | Lightweight stakeholder, research, or reconnaissance context tracked as markdown under `docs/discovery/`. May later inform a numbered doc, RFC, or ADR. | `docs/STANDARDS.md` section "Discovery folder" |
